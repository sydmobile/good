...
public class L {
    ...
    public static void e(String msg) {
        if (AppConstant.DEBUG) {
            Log.e(AppConstant.LOG_CONFIG.DEFAULT_TAG, msg + "");
        }
    }
     ...
     * @param msg 信息
     */
    public static void eTest(String tag, String msg) {
     ...
     * @param params 参数
     */
    public static void eDetail(String msg, Object... params) {
        eDetail("", msg, params);
     ...
     */
    public static void eDetail(String tag, String msg, Object... params) {
        if (!AppConstant.DEBUG) {
            return;
        }
    ...
    private static String getFinalTag(String tag) {
        if (!StringUtils.isEmptyAfterTrim(tag)) {
            return AppConstant.LOG_CONFIG.DEFAULT_TAG + tag;
        } else {
            return AppConstant.LOG_CONFIG.DEFAULT_TAG;
        }
    }
