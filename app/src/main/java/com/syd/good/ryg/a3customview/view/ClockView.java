...
public class ClockView extends View {
    ...
    /** 加一个默认的 padding 值，为了防止用 camera 旋转时钟时造成四周超出 view 大小 */
    ...
    public ClockView(Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ClockView);
        mBackgroundColor = a.getColor(R.styleable.ClockView_clock_backgroundColor, Color.parseColor("#FF00FF"));
        mLightColor = a.getColor(R.styleable.ClockView_clock_lightColor,Color.parseColor("#FFFFFF"));
        mDarkColor = a.getColor(R.styleable.ClockView_clock_darkColor,Color.parseColor("#80FFFFFF"));
        mTextSize = a.getDimension(R.styleable.ClockView_clock_textSize,36);
        a.recycle();
